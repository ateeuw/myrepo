...
comm_class[["compisite foods*"]] <- c("food", "other food", "food at home", "food away from home", "processed food",
...
comm_class[["fodder crops and derived products"]] <- c("animal feed", "feedgrain", "fodder crop", "fonio")
