...
timpl_class[["food retail entities"]] <- c("retailer", "stores", "bakeries", "restaurants")
...
timpl_class[["non-agricultural land users"]] <- c("plantation forest owners")

timpl_class[["transport entities"]] <- c("transporters")