...
timpl_class[["non-food manufacturing/processing entities"]] <- c("agricultural machinery manufacturing industry")
timpl_class[["food consuming entities"]] <- c("consumer", "resident/consumer")
timpl_class[["citizen entities"]] <- c("citizen", "volunteers", "women")
timpl_class[["food retail entities"]] <- c("retailer", "stores")
